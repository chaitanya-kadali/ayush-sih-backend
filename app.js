...
app.use(cors({
  origin: ['http://localhost:5173','http://localhost:5174','http://localhost:5175', 'https://ayush-sih-2024-frontend.vercel.app/',/^https:\/\/ayush-sai-2024-frontend\.vercel\.app(\/.*)?$/ ],  // Allows requests from this frontend url
